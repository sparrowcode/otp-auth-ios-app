...
let package = Package(
    ...
    dependencies: [
        .package(name: "Firebase", url: "https://github.com/firebase/firebase-ios-sdk", .upToNextMajor(from: "10.16.0")),
        ...
        .package(url: "https://github.com/sparrowcode/AlertKit", .upToNextMajor(from: "5.1.4")),
