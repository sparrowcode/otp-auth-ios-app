...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/sparrowcode/SwiftBoost", .upToNextMajor(from: "4.0.5")),
        ...
        .package(url: "https://github.com/sparrowcode/AlertKit", .upToNextMajor(from: "5.1.7")),
